...
import nl.arnhem.flash.utils.createMediaFile
...
class DownloadService : IntentService("FlashVideoDownloader") {

    companion object {
        const val EXTRA_URL = "download_url"
        private const val MAX_PROGRESS = 1000
        private const val DOWNLOAD_GROUP = "Flash_downloads"
    }
    ...
    override fun onHandleIntent(intent: Intent?) {
        ...
        notifBuilder = flashNotification
    ...
    private fun getPendingIntent(context: Context, file: File): PendingIntent {
        val uri = context.flashUriFromFile(file)
