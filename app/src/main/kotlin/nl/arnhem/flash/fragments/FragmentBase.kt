...
abstract class BaseFragment : Fragment(), FragmentContract, DynamicUiContract {
    ...
    override var valid: Boolean
        ...
        set(value) {
            ...
            flashAnswersCustom("Native Fallback",
    ...
    override var content: FlashContentParent? = null
    ...
    final override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val content = view  as? FlashContentParent
                ?: throw IllegalArgumentException("layoutRes for fragment must return view implementing FlashContentParent")
