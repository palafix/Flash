 ...
 */
class FlashVideoView @JvmOverloads constructor(
    ...
    private lateinit var viewerContract: FlashVideoViewerContract
    lateinit var containerContract: FlashVideoContainerContract
    ...
    fun setViewerContract(contract: FlashVideoViewerContract) {
