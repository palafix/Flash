...
import nl.arnhem.flash.dbflow.CookiesDb
import nl.arnhem.flash.dbflow.FbTabsDb
import nl.arnhem.flash.dbflow.NotificationDb
...
//    companion object {
//        fun refWatcher(c: Context) = (c.applicationContext as FlashApp).refWatcher
//    }
...
//        refWatcher = LeakCanary.install(this)
        if (!BuildConfig.DEBUG) {
            ...
            Crashlytics.setUserIdentifier(Prefs.FlashId)
        }
